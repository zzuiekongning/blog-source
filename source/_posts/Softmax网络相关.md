...
plt.show()
```
![The toy spiral data consists of three classes (blue, red, yellow) that are not linearly separable](Softmax网络相关/spiral_raw.png)
...
![Linear classifier fails to learn the toy spiral dataset](Softmax网络相关/spiral_linear.png)
...
![Neural Network classifier crushes the spiral dataset](Softmax网络相关/spiral_net.png)
